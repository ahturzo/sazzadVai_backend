...
<!--                                  <a class="dropdown-item" @click.prevent="viewDetails(cheque)"><i class="fa fa-eye mr-1"></i> Details</a>-->

                                  <template v-if="user.roles[0] == 'ADMIN' && post.status == 'PENDING'">
                                    <a class="dropdown-item" @click.prevent="approvePost(post.id)"><i class="fa fa-exchange mr-1"></i> Approve</a>
                                  </template>
                                </div>
                              </div>
                            </td>
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <form>
                      <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <textarea id="description" class="form-control"
                                   :class="{ 'is-invalid': form.errors.has('description') }"
                                      v-model="form.description" type="text" placeholder="About your self"></textarea>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group position-relative has-icon-left">
                            <input type="file" @change="changeContent($event)" :class="{ 'is-invalid': form.errors.has('image') }">
                      ...
                      <div class="row">
                        <div class="col-md-9">
                          <small class="text-danger">Fill the form correctly with all mandatory fields(*) and click the “Save” button.</small><br>
                        </div>
                        <div class="col-md-3">
